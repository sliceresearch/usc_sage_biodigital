...
var usc_biodigital = SAGE2_App.extend({
	init: function(data) {
		...
		this.element.innerHTML = `<iframe id="${iframe_id}" src="${source}"
			...
			<div id="quizPanel_${this.id}" class="quizPanel">
				...
				<h3 id="quizSel_${this.id}"
					class="quizSel"><b><span id="quizTarget_${this.id}"
						class="quizTarget"></span></b></h3>
				<div id="quizItems_${this.id}"
					class="quizItems"><ul id="quizList_${this.id}"
						class="quizList"></ul></div>
	...
	invariant: function() {
		...
		switch (qState) {
			...
			case "Quiz Loaded":
				...
				this.assertTrue(typeof(this.state.quizName) == "string", "quizName");
				...
				case "ModelType":
					switch (data.value) {
						case "Heart":
							...
							this.humanIframe.src = "https://human.biodigital.com/widget" +
								"?be=1to1&pre=false&background=255,255,255,51,64,77&dk=" +
								this.state.dk;
							this.reset();
						...
						case "Male":
							...
							this.humanIframe.src = "https://human.biodigital.com/widget" +
								"?be=1ud8&pre=false&background=255,255,255,51,64,77&dk=" +
								this.state.dk;
							this.reset();
							this.pointerTypeRadioButton.value = "Spin";
							break;
						...
						case "Quiz":
							...
							this.humanIframe.src = "https://human.biodigital.com/widget" +
								"?be=1fLs&pre=false&background=255,255,255,51,64,77&dk=" +
								this.state.dk;
							this.reset();
							this.pointerTypeRadioButton.value = "Spin";
							break;
